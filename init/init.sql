...
-- Veritabanı adı belirtildiği için 'USE bookDB' komutuna gerek yok
CREATE TABLE bookDB.dbo.Books (
...
INSERT INTO bookDB.dbo.Books (Title, Description, Author, Rate, DateStart, DateRead)
VALUES 
